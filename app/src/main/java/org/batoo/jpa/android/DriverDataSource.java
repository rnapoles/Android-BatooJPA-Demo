...
public final class DriverDataSource implements DataSource
{
   ...
   private static final BLogger LOGGER = BLoggerFactory.getLogger(DriverDataSource.class);

   private final String jdbcUrl;
   private final Properties driverProperties;
   private Driver driver;

   public DriverDataSource(Properties properties)
   {
      ...
      this.jdbcUrl = driverProperties.getProperty("jdbcUrl","");
      String driverClassName = driverProperties.getProperty("driverClassName", null);
      ...
      if (driverClassName != null) {
         ...
         if (driver == null) {
            ...
            try {
        	 ...
        	 System.err.println("Driver Cargado:"+driver.getClass().getCanonicalName()); 
         }
      }
